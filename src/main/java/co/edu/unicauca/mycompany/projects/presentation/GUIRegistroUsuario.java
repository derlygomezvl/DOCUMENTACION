...
public class GUIRegistroUsuario extends javax.swing.JFrame {
     ...
     */
    public GUIRegistroUsuario(UserService userService) {
    ...
    private void fillPrograms() {
        ...
        cboPrograma.addItem("Ingeniería de Sistemas");
        cboPrograma.addItem("Ingeniería Electrónica y Telecomunicaciones");
        cboPrograma.addItem("Automática Industrial");
        cboPrograma.addItem("Tecnología en Telemática");
    }

    private void fillRoles() {
        cboRol.removeAllItems();
        cboRol.addItem("estudiante");
        cboRol.addItem("director");
        cboRol.addItem("jurado");
        // Nota: roles como "comite", "secretaria", "jefe_departamento" 
        // generalmente se crean por administrador, no por registro público
    }

     @SuppressWarnings("unchecked")
    private void initComponents() {
        // ... (código generado por NetBeans para la interfaz)
        // Asegúrate de tener estos campos:
        // txtNombres, txtApellidos, txtCelular, cboPrograma, cboRol, txtEmail, txtPassword, txtConfirmPassword
    ...
    private void initComponents() {
        ...
        cboComSector.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboComSectorActionPerformed(evt);
            }
        });
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        String programa = cboPrograma.getSelectedItem().toString();
        ...
        if (!password.equals(confirmPassword)) {
            Messages.mensajeVario("Las contraseñas no coinciden");
            return;
        }
    ...
    private void cboComSectorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboComSectorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboComSectorActionPerformed
